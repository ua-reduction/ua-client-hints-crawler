(function() {
    ...
    // The script calls the get method of the navigator object.
    interceptFunctionCall(NavigatorUAData, "getHighEntropyValues");
    // Old User Agent API calls
    interceptPropAccess(Navigator, "userAgent");
    // The script calls the get method of the NetworkInformation.
    interceptPropAccess(NetworkInformation, "rtt");
    interceptPropAccess(NetworkInformation, "downlink");
    interceptPropAccess(NetworkInformation, "effectiveType");
    interceptPropAccess(NetworkInformation, "saveData");
    // Topics API calls
    interceptFunctionCall(Document, 'browsingTopics');
    // interceptFunctionCall(navigator.userAgentData, "getHighEntropyValuess");
